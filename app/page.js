...
const Asistent = () => {
   ...
   const renderAnswer = () => {}
    ...
    const [availbleVoices, setAvailbleVoices] = useState([ { name: "Alex", lang: "en-US", gender: "male" },
    { name: "Samantha", lang: "en-US", gender: "female" },
    { name: "John", lang: "en-GB", gender: "male" },
            ...
            <div className="text-center mb-2 sm:mb-3 px-2">
                ...
                {availbleVoices.length > 0 && (
                    <div className="mb-4" >
                        ...
                        <p className=" text-xs text-gray-500 mt-1">{ availbleVoices.length} Cricket Pundits avilble as of now.</p>
                    </div>
                )}
                 </div>
